...
// --- Универсальный парсер YouTube URL → embed ---
...
const CONTACTS = {
  ...
  email:
    "mailto:herman186198@gmail.com?subject=Phuket%20Condo&body=Здравствуйте!%20Пишу%20по%20квартире.",
    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900 pb-24 md:pb-0" data-testid="root">
      ...
      <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-neutral-200">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-2xl bg-neutral-900 text-white grid place-items-center font-bold">
              PH
            </div>
            <div>
              <div
                className="text-xs sm:text-sm uppercase tracking-wide text-neutral-600"
                data-testid="project"
              >
                {DETAILS.project}
              </div>
              <h1 className="text-base sm:text-lg font-semibold leading-tight" data-testid="title">
                {DETAILS.title}
              </h1>
            </div>
          </div>
          <div className="hidden md:flex items-center gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-2 rounded-2xl bg-sky-600 text-white hover:bg-sky-700 transition"
            >
              Telegram
            </a>
            <a
              href={CONTACTS.phone}
              className="px-4 py-2 rounded-2xl bg-neutral-900 text-white hover:bg-black transition"
            >
              Позвонить
            </a>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-8 md:py-12">
        <div className="grid md:grid-cols-2 gap-6 items-start">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden relative"
          >
            <div className="aspect-video bg-black/5 relative">
              ...
              {isDesktop && (
                <button
                  ...
                  className="absolute bottom-3 right-3 px-3 py-1.5 rounded-lg bg-black/70 text-white text-sm hover:bg-black"
            ...
            <div className="p-4 md:p-5">
              ...
              <p className="mt-1 text-neutral-600 text-sm">
                Интервью о проекте, локации и инфраструктуре комплекса.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-baseline justify-between gap-3">
                ...
                <a
                  href="#contact"
                  className="px-3 sm:px-4 py-2 rounded-2xl bg-neutral-900 text-white hover:bg-black transition text-sm sm:text-base"
                >
              ...
              >
                <div className="relative max-w-5xl w-full">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 w-10 h-10 rounded-full bg-black/70 text-white text-xl hover:bg-black"
                  >
                    ×
                  </button>
                  <button
                    ...
                    className="absolute left-2 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/60 text-white text-2xl hover:bg-black"
                  >
                    ‹
                  </button>
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/60 text-white text-2xl hover:bg-black"
                  >
                    ›
                  </button>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-12">
        ...
        >
          ...
          <p className="mt-3 text-neutral-700 leading-relaxed text-sm md:text-base">
            Светлая 1-спальная квартира в современном комплексе рядом с пляжем Банг Тао.
            Идеальна для личного проживания и для аренды. Меблировка включена, техника
            установлена. Комплекс с бассейном, тренажёрным залом, ресепшн, охраной 24/7 и
            парковкой.
          </p>
          <p className="mt-3 text-neutral-700 leading-relaxed text-sm md:text-base">
            В видео выше — интервью о проекте, локации и инфраструктуре. По запросу
            предоставим брошюру, планировки и дополнительные фото.
          </p>
        </motion.div>
      </section>
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center px-4 py-3 rounded-2xl bg-green-600 text-white hover:bg-green-700 transition text-sm md:text-base"
                data-testid="cta-wa"
              >
                Написать в WhatsApp
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center px-4 py-3 rounded-2xl bg-sky-600 text-white hover:bg-sky-700 transition text-sm md:text-base"
                data-testid="cta-tg"
              >
                Написать в Telegram
              </a>
              <a
                href={CONTACTS.phone}
                className="block w-full text-center px-4 py-3 rounded-2xl bg-neutral-900 text-white hover:bg-black transition text-sm md:text-base"
              ...
              <a
                href={CONTACTS.email}
                className="block w-full text-center px-4 py-3 rounded-2xl bg-neutral-200 text-neutral-900 hover:bg-neutral-300 transition text-sm md:text-base"
            ...
            {formStatus === "ok" ? (
              ...
              <form onSubmit={handleSubmit} className="grid gap-3" data-testid="form">
                <input
                  ...
                  required
                  className="px-4 py-3 rounded-2xl border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-900"
                />
                <input
                  type="text"
                  name="contact"
                ...
                <input
                  type="hidden"
                  name="_subject"
                  value="Заявка с сайта: OZONE Oasis condominium Bang Tao"
                />
                <button
                  type="submit"
                  disabled={formStatus === "sending"}
                  className="px-4 py-3 rounded-2xl bg-neutral-900 text-white hover:bg-black transition disabled:opacity-60"
                >
                ...
                {formStatus === "error" && (
                  <div className="text-sm text-red-600">
                    Не удалось отправить. Попробуйте ещё раз или напишите в WhatsApp/Telegram.
                  </div>
                )}
              </form>
            )}
      ...
      <div className="fixed md:hidden bottom-3 inset-x-3 z-40">
        <div className="bg-white border border-neutral-200 rounded-2xl shadow-lg p-2 grid grid-cols-3 gap-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-center px-3 py-2 rounded-xl bg-green-600 text-white text-sm"
          >
            WhatsApp
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-center px-3 py-2 rounded-xl bg-sky-600 text-white text-sm"
          >
            Telegram
          </a>
          <a
            href={CONTACTS.phone}
            className="text-center px-3 py-2 rounded-xl bg-neutral-900 text-white text-sm"
          >
            Звонок
          </a>
        </div>
      ...
      <footer className="border-t border-neutral-200 bg-white/60">
        <div className="max-w-6xl mx-auto px-4 py-6 text-sm text-neutral-600 flex flex-col md:flex-row gap-2 md:items-center md:justify-between">
          ...
          <div>
            Собственник:{" "}
            <a href={CONTACTS.phone} className="underline decoration-dotted">
              связаться
            </a>
          </div>
        </div>
